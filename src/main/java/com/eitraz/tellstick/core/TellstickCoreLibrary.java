...
public interface TellstickCoreLibrary extends Library {
	...
	public interface TDDeviceEvent extends Callback {
		public void event(int deviceId, int method, Pointer data, int callbackId, Pointer context);
	}
	...
	public interface TDRawDeviceEvent extends Callback {
		public void event(Pointer data, int controllerId, int callbackId, Pointer context);
	}
	...
	public Pointer tdGetDeviceParameter(int intDeviceId, Pointer strName, Pointer defaultValue);
	...
	public int tdSendRawCommand(Pointer command, int reserved);

	// TELLSTICK_API void WINAPI tdConnectTellStickController(int vid, int pid, const char *serial);
	public void tdConnectTellStickController(int vid, int pid, Pointer serial);

	// TELLSTICK_API void WINAPI tdDisconnectTellStickController(int vid, int pid, const char *serial);
	public void tdDisconnectTellStickController(int vid, int pid, Pointer serial);
	...
	public int tdSensorValue(Pointer protocol, Pointer model, int id, int dataType, Pointer value, int len, LongByReference timestamp);
	...
	public int tdControllerValue(int controllerId, Pointer name, Pointer value, int valueLen);

	// TELLSTICK_API int WINAPI tdSetControllerValue(int controllerId, const char *name, const char *value);
	public int tdSetControllerValue(int controllerId, Pointer name, Pointer value);
