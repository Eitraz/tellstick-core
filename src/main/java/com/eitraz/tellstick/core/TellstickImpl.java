...
import com.eitraz.tellstick.core.device.DeviceHandlerImpl;
...
public class TellstickImpl implements Tellstick {
    private static final Logger logger = Logger.getLogger(TellstickImpl.class);
    ...
    public void start() {
        ...
        deviceHandler = new DeviceHandlerImpl(library, SUPPORTED_METHODS);
        deviceHandler.start();
